...
public class CustomArtemisHttpUtil {
    ...
    public CustomArtemisHttpUtil(String host, String appKey, String appSecret) {
        this.host = host;
        this.appKey = appKey;
    ...
    public String doGetArtemis(Map<String, String> path, Map<String, String> querys, String accept, String contentType, Map<String, String> header) {
        ...
        try {
            ...
            Request request = new Request(Method.GET, httpSchema + this.host,
                    path.get(httpSchema), this.appKey,this.appSecret, Constants.DEFAULT_TIMEOUT);
    ...
    public String doGetArtemis(Map<String, String> path, Map<String, String> querys, String accept, String contentType) {
     ...
     */
    public HttpResponse doGetResponse(Map<String, String> path, Map<String, String> querys, String accept, String contentType, Map<String, String> header) {
        ...
        try {
            ...
            Request request = new Request(Method.GET_RESPONSE, httpSchema + this.host,
                    path.get(httpSchema), this.appKey,this.appSecret, Constants.DEFAULT_TIMEOUT);
            request.setHeaders(headers);
    ...
    public String doPostFormArtemis(Map<String, String> path, Map<String, String> paramMap, Map<String, String> querys, String accept, String contentType, Map<String, String> header) {
        /**
         * 根据传入的path获取是请求是http还是https
         */
        String httpSchema = (String) path.keySet().toArray()[0];
        ...
        try {
            ...
            Request request = new Request(Method.POST_FORM, httpSchema + this.host,
                    path.get(httpSchema), this.appKey,this.appSecret, Constants.DEFAULT_TIMEOUT);
            request.setHeaders(headers);
            //postForm请求的query参数
            request.setQuerys(querys);
    ...
    public String doPostFormArtemis(Map<String, String> path, Map<String, String> paramMap, Map<String, String> querys, String accept, String contentType) {
        /**
         * 根据传入的path获取是请求是http还是https
         */
        String httpSchema = (String) path.keySet().toArray()[0];
     ...
     */
    public HttpResponse doPostFormImgArtemis(Map<String, String> path, Map<String, String> paramMap, Map<String, String> querys, String accept, String contentType, Map<String, String> header) {
        /**
         * 根据传入的path获取是请求是http还是https
         */
        String httpSchema = (String) path.keySet().toArray()[0];
        ...
        try {
            ...
            Request request = new Request(Method.POST_FORM_RESPONSE, httpSchema + this.host,
                    path.get(httpSchema), this.appKey,this.appSecret, Constants.DEFAULT_TIMEOUT);
            request.setHeaders(headers);
            //postForm请求的query参数
            request.setQuerys(querys);
    ...
    public String doPostStringArtemis(Map<String, String> path, String body,
        ...
        try {
            ...
            Request request = new Request(Method.POST_STRING, httpSchema + this.host,
                    path.get(httpSchema), this.appKey,this.appSecret, Constants.DEFAULT_TIMEOUT);
            request.setHeaders(headers);
            //请求的query
            request.setQuerys(querys);
    ...
    public HttpResponse doPostStringImgArtemis(Map<String, String> path, String body,
        ...
        try {
            ...
            Request request = new Request(Method.POST_STRING_RESPONSE, httpSchema + this.host,
                    path.get(httpSchema), this.appKey,this.appSecret, Constants.DEFAULT_TIMEOUT);
            request.setHeaders(headers);
            //请求的query
            request.setQuerys(querys);
     ...
     * @param contentType 请求的与实体对应的MIME信息，该参数传空时的取默认值("application/text; charset=UTF-8")
     */
    public String doPostBytesArtemis(Map<String, String> path, byte[] bytesBody, Map<String, String> querys, String accept, String contentType, Map<String, String> header) {
        /**
         * 根据传入的path获取是请求是http还是https
         */
        String httpSchema = (String) path.keySet().toArray()[0];
        ...
        try {
            ...
            Request request = new Request(Method.POST_BYTES, httpSchema + this.host,
                    path.get(httpSchema), this.appKey,this.appSecret, Constants.DEFAULT_TIMEOUT);
            request.setHeaders(headers);
            //请求的query
            request.setQuerys(querys);
     ...
     * @param contentType 请求的与实体对应的MIME信息，该参数传空时的取默认值("application/text; charset=UTF-8")
     */
    public String doPostBytesArtemis(Map<String, String> path, byte[] bytesBody, Map<String, String> querys, String accept, String contentType) {
        /**
         * 根据传入的path获取是请求是http还是https
         */
        String httpSchema = (String) path.keySet().toArray()[0];
     ...
     * @param contentType 请求的与实体对应的MIME信息，该参数传空时的取默认值("application/text; charset=UTF-8")
     */
    public String doPutStringArtemis(Map<String, String> path, String body, String accept, String contentType) {
        /**
         * 根据传入的path获取是请求是http还是https
         */
        String httpSchema = (String) path.keySet().toArray()[0];
        ...
        try {
            ...
            Request request = new Request(Method.PUT_STRING, httpSchema + this.host,
                    path.get(httpSchema), this.appKey,this.appSecret, Constants.DEFAULT_TIMEOUT);
            request.setHeaders(headers);
            request.setStringBody(body);
     ...
     * @param contentType 请求的与实体对应的MIME信息，该参数传空时的取默认值("application/text; charset=UTF-8")
     */
    public String doPutBytesArtemis(Map<String, String> path, byte[] bytesBody, String accept, String contentType) {
        ...
        try {
            ...
            Request request = new Request(Method.PUT_BYTES, httpSchema + this.host,
                    path.get(httpSchema), this.appKey,this.appSecret, Constants.DEFAULT_TIMEOUT);
            request.setHeaders(headers);
            request.setBytesBody(bytesBody);
            //调用服务端
     ...
     * @param contentType 请求的与实体对应的MIME信息，该参数传空时的取默认值
     */
    public String doDeleteArtemis(Map<String, String> path, Map<String, String> querys, String accept, String contentType) {
        /**
         * 根据传入的path获取是请求是http还是https
         */
        String httpSchema = (String) path.keySet().toArray()[0];
        ...
        try {
            ...
            Request request = new Request(Method.DELETE, httpSchema + this.host,
                    path.get(httpSchema), this.appKey,this.appSecret, Constants.DEFAULT_TIMEOUT);
            request.setHeaders(headers);
            request.setQuerys(querys);
            //调用服务端
