  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/datarailwayorder/dataRailwayOrder/add",
          edit: "/datarailwayorder/dataRailwayOrder/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'orderId','salesChannels','productName','buyNumber','contactPerson','mobile','useTime','orderPrice','payType','orderStatus','createBy','createTime','updateTime'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'orderId','salesChannels','productName','buyNumber','contactPerson','mobile','useTime','orderPrice','payType','orderStatus','createBy','createTime','updateTime'))
      },
