    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="收货人" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'consignee', validatorRules.consignee]" placeholder="请输入收货人"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/datagoods/dataGoods/add",
          edit: "/datagoods/dataGoods/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'orderId','orderChannel','productName','buyNumber','consignee','mobile','orderPrice','payType','orderStatus','createBy','createTime','updateTime'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'orderId','orderChannel','productName','buyNumber','consignee','mobile','orderPrice','payType','orderStatus','createBy','createTime','updateTime'))
      }
