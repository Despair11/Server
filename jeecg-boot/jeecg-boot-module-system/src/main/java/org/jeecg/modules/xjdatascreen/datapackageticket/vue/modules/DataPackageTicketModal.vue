    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="订单编号" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'orderId', validatorRules.orderId]" placeholder="请输入订单编号"></a-input>
        </a-form-item>
        <a-form-item label="销售渠道" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'salesChannels', validatorRules.salesChannels]" placeholder="请输入销售渠道"></a-input>
        </a-form-item>
        ...
        <a-form-item label="子票名称" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'ticketName', validatorRules.ticketName]" placeholder="请输入子票名称"></a-input>
        </a-form-item>
        ...
        <a-form-item label="第三方订单" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'thirdOrderId', validatorRules.thirdOrderId]" placeholder="请输入第三方订单"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/datapackageticket/dataPackageTicket/add",
          edit: "/datapackageticket/dataPackageTicket/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'orderId','salesChannels','productName','ticketName','buyNumber','contactPerson','mobile','useTime','orderPrice','payType','orderStatus','payOrderId','thirdOrderId','createBy','createTime','updateTime'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'orderId','salesChannels','productName','ticketName','buyNumber','contactPerson','mobile','useTime','orderPrice','payType','orderStatus','payOrderId','thirdOrderId','createBy','createTime','updateTime'))
      },
